...
# Adding, renaming, removing events
...
We will use this TimeSeries that contains [cyclic kinetic data in wheelchair propulsion](../../5%20Appendix/dataset_kinetics_wheelchair_propulsion.md):
...
:::{note}
Matplotlib must be interactive. See section [](../../3%20Part%20I%20-%20Learning%20Python%20for%20Biomechanics/1%20Getting%20Started/3_getting_started_configuring_spyder.md) do help.
:::

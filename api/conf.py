...
ogp_site_url = "https://kineticstoolkit.uqam.ca/docs/api"
ogp_description_length = 200
ogp_site_name = "Kinetics Toolkit"
ogp_image = "https://kineticstoolkit.uqam.ca/docs/api/_static/logo-social.png"
